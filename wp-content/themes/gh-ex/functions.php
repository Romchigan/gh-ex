...
function _tk_setup() {
	...
	*/
	register_nav_menus( array(
		'header_nav'  => __( 'Header menu', '_tk' ),
		) );

    register_nav_menus( array(
        'footer_nav'  => __( 'Footer menu', '_tk' ),
    ) );
...
function _tk_scripts() {
	...
	// load _tk styles
    wp_enqueue_style( '_tk-style_theme', get_template_directory_uri() . '/vendors/css/style.css');
...
function wp_add_google_fonts() {
    ...
    wp_enqueue_style( 'wpb-google-fonts', 'https://fonts.googleapis.com/css?family=Roboto:400,700', false );
}
